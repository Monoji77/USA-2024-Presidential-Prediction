...
@fig-pollster_harris & @fig-pollster_trump show an interesting bump in predictions by George Mass. This may have been an error on their part however, as it is almost immediately rectified.
```{r}
